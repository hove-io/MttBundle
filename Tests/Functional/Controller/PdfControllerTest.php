...
{
    private function getRoute($route, $stopTimetableId = false, $externalNetworkId = Fixture::EXTERNAL_NETWORK_ID, $externalStopPointId = Fixture::EXTERNAL_STOP_POINT_ID)
    {
        return $this->generateRoute(
            ...
            array(
                ...
                "stopTimetableId" => $stopTimetableId != false ? $stopTimetableId : Fixture::$stopTimetableId
            )
        );
    }
    ...
    // {
    //     $crawler = $this->doRequestRoute($this->getRoute('canal_tp_mtt_stop_timetable_generate_pdf'), 302);
