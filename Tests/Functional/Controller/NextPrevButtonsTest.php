...
class NextPrevButtonsTest extends AbstractControllerTest
{
    ...
    public function testIsFirstStopOnlyOneButton()
    {
        ...
        $btn_count = $crawler->filter('#main-container > div.row > div.col-md-9 > div.row a')->count();
        $this->assertTrue($btn_count == 1 , "Expected one button for first stop. Found :$btn_count");
        $btn_count = $crawler->filter('#main-container > div.row > div.col-md-9 > div.row a span.glyphicon-chevron-right')->count();
    ...
    public function testIsLastStopOnlyOnePrevButton()
    {
        ...
        $btn_count = $crawler->filter('#main-container > div.row > div.col-md-9 > div.row a')->count();
        $this->assertTrue($btn_count == 1 , "Expected one button for first stop. Found :$btn_count");
        $btn_count = $crawler->filter('#main-container > div.row > div.col-md-9 > div.row a span.glyphicon-chevron-left')->count();
